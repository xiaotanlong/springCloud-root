package concurrentProgramming.deadlock.tranfer;

import concurrentProgramming.deadlock.tranfer.service.ITransfer;
import concurrentProgramming.deadlock.tranfer.service.SafeOperateToo;
/**
 *
 *类说明：模拟支付公司转账的动作
 */
